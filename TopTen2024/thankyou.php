<?php
	...
	switch($hat){
		case 'smallMed':$hat = 'S/M';
		break;
		case 'largeXlarge':$hat = 'L/XL';
	}
	switch ($wednesday) {
	...
	switch ($meal) {
		case 'vegetable':$meal = 'Roasted Vegetable Stack';			
		break;
		case 'bass':$meal = 'Miso Marinated Sea Bass';			
		break;
		case 'mignon':$meal = 'Grilled Filet Mignon';			
		break;
...
<html lang="en">
	...
	<body>
		...
		<p>The hat size you have chosen is <?php echo $hat ?>.</p>
