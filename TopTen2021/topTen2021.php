...
<html lang="en">
	<head>
		...
		<title>Endicott Brick,Face Brick, Thin Brick,Pavers,Tile</title>
	...
	<body>
		<div class="container-fluid">
			...
			<form action="TopTenThankYou.php" method="post" >
			<div class="row">
				<div class="col">
			...
			<div class="row" style="padding-top: 15px;">
				...
				<div class="col" >
					<p style="display: inline-block; font-weight: bolder">Apperal Size</p>	
			...
			<div class="row " style="border-bottom:solid thin black;">
				<div class="col-md-4" style="border-right:thin solid black">
					...
					<div class="row">
						<div class="col" style="height:400px;border-bottom:thin solid black;overflow: hidden;">
						...
						<div class="col" style="padding-top: 5px">
							<p style="display: inline-block; font-weight: bolder; ">Wednesday Meal</p></br>
								<div style="text-align: left">
									<input type="radio" name="meal" value="seaBass" required><p style="display: inline-block;margin-left: 5px">Grilled Sea Bass with Madiera Reduction and Morel Mushrooms</p></br>
									<input type="radio" name="meal" value="mignon" ><p style="display: inline-block;margin-left: 5px">Grilled Prime Center Cut Filet Mignon with Truffle Demi-Glace</p></br>
									<input type="radio" name="meal" value="Prawns" ><p style="display: inline-block;margin-left: 5px">Linguini with Jumbo Prawns, Lobster Cognac Sauce</p></br>
								</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col">
					...
					<span class="tabIn">&nbsp;&nbsp;Wednesday, April 1, 2020  - Torrey Pines South Course</span><br>
					<span class="tabIn">&nbsp;&nbsp;Thursday, April 2, 2020 – Torrey Pines North Course</span><br>	
					</p>
			...
			<div class="row">
				<div class="col">
					...
					<span class="tabIn">&nbsp;&nbsp;Full day fishing – Wednesday, April 1, 2020.<br></span>
						<span class="tabIn">&nbsp;&nbsp;Half day fishing  – Thursday, April 2, 2020.<br></span>
						<span class="tabIn">&nbsp;&nbsp;Each person going fishing will be required to have a CA license which can be purchased prior to arrival at this link:<a href="https://www.wildlife.ca.gov/Licensing/Fishing#758845-descriptions--fees" target="_blank"> Fishing Licence</a>
						</span>
						</p>
