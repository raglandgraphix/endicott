...
<html lang="en">
	<head>
		...
		<meta property="og:image" content="http://www.endicott.com/assets/Invisilug-sandbed.jpg" />
		<meta property="og:image:width" content="200" />
		<meta property="og:image:height" content="100" />
		<meta property="og:type" content="website" />
		<meta property="og:description" content="Endicott Clay Products Company Invisi-Lug&reg; pavers. " />
		...
		<title>INVISI-LUG&reg; Endicott</title>
	...
	<body>
		...
		<div id="invisi-lug_main">
			...
			<div id="invisi-lug_hero">
				...
				<video width="95%" muted loop autoplay playsinline>
					<source src="../assets/video/invisilug_home720.mp4" type="video/mp4">
				</video>
				<!-- <img id="invisi-lug_photo" src="invisi-lug_assets/invisi-lug_nobackground.png"> -->
				<div id="invisi-lug_buttonHolder"><button type="button" class="btn btn-secondary mb-5" id="invisi-lug_CTA">CONTACT US</button></div>
...
<div class="invisi-lug_sleeve">
				...
				<h4 class="invisi-lug_mt invisi-lug_caption ">New INVISI-LUG&reg; clay pavers from Endicott give you everything you have wanted in a paver:</h4>
				<ul>
					...
					<h5 class="invisi-lug_mt invisi-lug_caption ">INVISI-LUG&reg; Paver benefits are in addition to the traditional benefits of using Endicott clay pavers:</h5>
					<ul>
				...
				<!-- <h5 class="invisi-lug_mt invisi-lug_caption ">With Endicott's INVISI-LUG&reg; pavers, you get everything you have wanted.</h5> -->
				<figure>
		...
		<div id="invisi-lug_ty">
			<div id="invisi-lug_tySheet">
				<h3>THANK YOU!</h3>
			<p>Thank you for your interest in Endicott INVISI-LUG&reg; pavers. Someone will be reaching out to you soon.</p>
