	...
	<head>
		...
		<style>
			#header{
				...
				background:url(TorreyPinesCourse.jpg)no-repeat center center ;
		...
		<div class="container-fluid">
			...
			<div class="row " style="border-bottom:solid thin black;">
				<div class="col-sm-4" style="border-right:thin solid black">
					...
					<div class="row">
						<div class="col" style="height:400px;overflow: hidden;">
							<img style="height: 100%" id="day1Img" src="choose.jpg" />
						</div>
					</div>
				...
				<div class="col-sm-4" style="border-right:thin solid black;">
					...
					<div class="row">
						<div class="col" style="height:400px;overflow: hidden;">
							<img style="height: 100%" id="day2Img" src="choose.jpg" />
						</div>
					</div>
				...
				<div class="col-sm-4" >
						<div class="row " style="text-align: center; height: 100%">
							<div class="col" style="padding-top: 5px; border: thin solid black;">
								<p style="display: inline-block; font-weight: bolder; ">Wednesday Meal</p></br>
									<div style="text-align: left">
										<div class="row">
											<div class="col-sm-1">
												<input style="white-space: normal;"  type="radio" name="mealWed" value="seaBass" required>
											</div>
											<div class="col-sm-10">
												<p style="display: inline-block;margin-left: 5px">Grilled Sea Bass</p></br>
											</div>
										</div>
										
										<div class="row">
											<div class="col-sm-1">
												<input  type="radio" name="mealWed" value="mignon"  >
											</div>
											<div class="col-sm-10">
												<p style="display: inline-block;margin-left: 5px">Grilled Prime Center Cut Filet Mignon</p></br>
											</div>
										</div>
										
										<div class="row">
											<div class="col-sm-1">
												<input type="radio" name="mealWed" value="Prawns" >
											</div>
											<div class="col-sm-10">
												<p style="display: inline-block;margin-left: 5px">Linguini with Jumbo Prawns</p></br>
											</div>
										</div>
							...
							<div class="col" style="padding-top: 5px; border: thin solid black; height: 100%;">
								<p style="display: inline-block; font-weight: bolder; ">Thursday Meal</p></br>
									<div style="text-align: left">
										<div class="row">
											<div class="col-sm-1">
												<input type="radio" name="mealThurs" value="salmon" required>
											</div>
											<div class="col-sm-10">
												<p style="display: inline-block;margin-left: 5px">Applewood Hot Smoked Salmon</p></br>
											</div>
											
										</div>
										<div class="row">
											<div class="col-sm-1">
												<input type="radio" name="mealThurs" value="ribs" >
											</div>
											<div class="col-sm-10">
												<p style="display: inline-block;margin-left: 5px">Braised Beef Short Ribs</p></br>
											</div>
											
										</div>
										<div class="row">
											<div class="col-sm-1">
												<input type="radio" name="mealThurs" value="pasta" >
											</div>
											<div class="col-sm-10">
												<p style="display: inline-block;margin-left: 5px">Vegetarian Pasta</p></br>
											</div>
			...
			<div class="row">
				<div class="col">
					...
					<span class="tabIn">&nbsp;&nbsp;Wednesday, November 17, 2021  - Torrey Pines South Course</span><br>
					<span class="tabIn">&nbsp;&nbsp;Thursday, November 18, 2021 – Torrey Pines North Course</span><br>	
					</p>
			...
			<div class="row">
				<div class="col">
					<p>&bull;<span class="tabIn"> Fishing -  Guided Fishing provided by <a href="https://fishingbooker.com/charters/5602/san-diego-charters?booking_days=1&booking_persons=2&booking_children=0" target="_blank">San Diego Charters.</a> <br></span>
					<span class="tabIn">&nbsp;&nbsp;Full day fishing – Wednesday, November 17, 2021.<br></span>
						<span class="tabIn">&nbsp;&nbsp;Half day fishing  – Thursday, November 18, 2021.<br></span>
						<span class="tabIn">&nbsp;&nbsp;Each person going fishing will be required to have a CA license which can be purchased prior to arrival at this link:<a href="https://www.wildlife.ca.gov/Licensing/Fishing#758845-descriptions--fees" target="_blank"> Fishing License</a>
						</span>
						</p>
		...
		function setvals(){
			...
			if(day1Selection==''){
				...
				if(day1Selection=='golf'){
					$("#day1Img").attr('src','TorreyPinesCourse2.jpg');
			...
			if(day2Selection==''){
				...
				if(day2Selection=='golf'){
					$("#day2Img").attr('src','TorreyPinesCourse2.jpg');
